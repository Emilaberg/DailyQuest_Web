  ...
  return (
    <>
      <section className="w-full min-h-screen flex flex-col justify-center items-center">
        <h1 className="text-center text-white text-6xl mb-32">FAQ PAGE</h1>
        {/* accordion container */}
        <div className="w-[40%] flex flex-col gap-3">
            ...
            <div className="opacity-0 max-h-0 overflow-hidden text-white transition-all ease-in-out duration-500">
              <div>
                <p className="py-2 pl-4 font-bold text-lightSlateGray">
                  This question addresses the variety of content available.
                  Users want to know if the quizzes cover different genres, such
                  as general gaming knowledge, specific game franchises, or even
          ...
          >
            ...
            <div className="opacity-0 max-h-0 overflow-hidden text-white transition-all ease-in-out duration-500">
              <div>
                <p className="py-2 pl-4 font-bold text-lightSlateGray">
                  This question explains the process of joining the daily
                  quizzes. It can include details on whether users need to
                  create an account, how to access the quizzes, and any specific
                  steps they need to follow to participate.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex text-adminLightSlateGray font-bold text-2xl justify-between cursor-pointer items-center">
              {/* prompt */}
              <span>
                Are there any rewards or prizes for participating in the
                quizzes?
              </span>
              {/* icon */}
              <svg
            ...
            <div className="opacity-0 max-h-0 overflow-hidden text-white transition-all ease-in-out duration-500">
              <div>
                <p className="py-2 pl-4 font-bold text-lightSlateGray">
                  Users are often motivated by incentives. This question
                  clarifies if there are any rewards, such as points, badges, or
                  even tangible prizes for high scores or consistent
                  participation.
                </p>
              </div>
            </div>
            ...
            <div className="opacity-0 max-h-0 overflow-hidden text-white transition-all ease-in-out duration-500">
              <div>
                <p className="py-2 pl-4 font-bold text-lightSlateGray">
                  ...
                  explanation can include guidelines for submission and any
                  review process.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex text-adminLightSlateGray font-bold text-2xl justify-between cursor-pointer items-center">
              {/* prompt */}
              <span>
                How do you ensure the accuracy of the quiz questions and
                answers?
              </span>
              {/* icon */}
              <svg
            ...
            <div className="opacity-0 max-h-0 overflow-hidden text-white transition-all ease-in-out duration-500">
              <div>
                <p className="py-2 pl-4 font-bold text-lightSlateGray">
                  ...
                  sources used, the review process, and any expert involvement
