    ...
    <>
      <div className="w-full h-48 mt-14 mr-1 ml-1">
        ...
        <div className="flex flex-row justify-center gap-2 md:ml-5 md:mr-5 md:gap-4 lg:gap-6 ">
          ...
          <button className="w-[33%] h-10 border-[3px] rounded-[12px] border-primaryblue bg-slateBlue  text-lightSlateGray text-[12px] font-semibold flex flex-row items-center justify-between pl-3 pr-3 hover:bg-hoverBlueHelp md:h-16 md:text-[20px] md:pl-5 md:justify-between lg:text-[26px] lg:h-24">
            Email us
            <img
